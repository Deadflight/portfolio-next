...
export const projects: IProject[] = [
  ...
  },
  {
    ...
    title: "Farmaloop",
    description:
      "FarmaLoop es la primera farmacia online basada en economía circular y enfocada en pacientes crónicos. Compra online tus medicamentos en Chile.",
    challenge:
      "Desarrollar y mantener una plataforma de farmacia online con enfoque en economía circular",
    solution:
      "Desarrollo de módulos administrativos, punto de venta (POS) y optimización de pedidos en tiempo real",
    results:
      "Módulos internos usados por +10 empleados, ventas en menos de 5 minutos y eficiencia operativa +30%",
