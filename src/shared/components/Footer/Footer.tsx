...
export const Footer = (): JSX.Element => {
  return (
    <footer className="bg-text-main text-background-main py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            <h3 className="text-xl font-heading font-bold mb-4">Portfolio</h3>
            <p className="font-body text-background-main/80 leading-body">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a
                  href="#inicio"
                  className="font-body text-background-main/80 hover:text-background-main transition-colors duration-200"
                >
                  Inicio
                </a>
              </li>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <p className="font-body text-background-main/80">
                Trabajo Remoto
              </p>
            </div>
          </div>
        ...
        <div className="border-t border-background-main/20 pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center">
            <p className="font-body text-background-main/80 text-sm mb-4 sm:mb-0 flex items-center">
